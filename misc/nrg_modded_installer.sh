...
#   1.2.16 20200818  AG Remove Firefox Send and Include Keystore Uploading Instructions. Core Node log verbosity set to 3 by default.
#
: '
...
# The following has been deprecated due to Firefox Send being offline.
'
_copy_keystore() {
...
echo
echo "Please copy the keystore file to ${CONF_DIR}/keystore directory on your own using"
echo "an sftp software like WSFTP or WinSCP."
read -p "Press Enter Once Done to finish the Core Node Installation." -r
}
